...
class FeishuChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        # Create event handler (register optional events only when supported)
        ...
        # A dedicated event loop avoids "This event loop is already running" issues.
        def run_ws():
            import time
    ...
    def _on_bot_p2p_chat_entered(self, data: Any) -> None:
        """Ignore bot chat entered events."""
